...
link:grub/[] TODO cleanup and exemplify everything in that file. Some hosty stuff needs to go out maybe.
...
Outcome: GRUB menu with a single `Buildroot` entry. When you select it, a tiny pre-built Linux image boots from: https://github.com/cirosantilli/linux-kernel-module-cheat
